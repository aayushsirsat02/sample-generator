...
public class CreateSampleReportRequest {
     ...
     * NEW OPTIONAL FIELDS
     *
     * marketValueBaseYear    : market value for the base year
     * marketValueForecastYear: market value for the forecast year
     * category               : report category (optional, auto-set if blank)
     */
